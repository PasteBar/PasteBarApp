...
var f$1 = {}
e(f$1, { convertFileSrc: () => w, invoke: () => c$2, transformCallback: () => s$2 })
function u$2() {
...
function s$2(e, r = !1) {
  ...
  return (
    Object.defineProperty(window, t, {
      value: o => (r && Reflect.deleteProperty(window, t), e == null ? void 0 : e(o)),
      writable: !1,
      configurable: !0,
    }),
    n
...
var W$1 = {}
e(W$1, { TauriEvent: () => c$1, emit: () => D, listen: () => E$1, once: () => _ })
...
var m = class {
  ...
  W = (a => (
    (a[(a.Critical = 1)] = 'Critical'), (a[(a.Informational = 2)] = 'Informational'), a
  ))(W || {})
function f() {
  return new s(window.__TAURI_METADATA__.__currentWindow.label, { skip: !0 })
}
function M() {
  return window.__TAURI_METADATA__.__windows.map(i => new s(i.label, { skip: !0 }))
}
var P = ['tauri://created', 'tauri://error'],
  u = class {
    ...
    _handleTauriEvent(e, a) {
      return P.includes(e)
        ? (e in this.listeners ? this.listeners[e].push(a) : (this.listeners[e] = [a]),
          !0)
        : !1
    }
  },
  h = class extends u {
    ...
    async requestUserAttention(e) {
      let a$1 = null
      return (
        e && (e === 1 ? (a$1 = { type: 'Critical' }) : (a$1 = { type: 'Informational' })),
        a({
          __tauriModule: 'Window',
          message: {
            cmd: 'manage',
  ...
  y = class {
    constructor(e) {
      ...
      ;(this.event = e.event), (this.windowLabel = e.windowLabel), (this.id = e.id)
    }
    preventDefault() {
    ...
    constructor(e, a$1 = {}) {
      super(e),
        (a$1 != null && a$1.skip) ||
          a({
            __tauriModule: 'Window',
            message: { cmd: 'createWebview', data: { options: { label: e, ...a$1 } } },
          })
...
async function saveWindowState(flags) {
  c$2('plugin:window-state|save_window_state', { flags })
}
/**
 *  Restore the state for the specified window from disk.
 */
async function restoreState(label, flags) {
  c$2('plugin:window-state|restore_state', { label, flags })
}
/**
