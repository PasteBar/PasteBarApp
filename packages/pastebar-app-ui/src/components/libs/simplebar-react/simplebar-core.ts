...
interface Options {
  ...
  ariaLabel: string
  onScroll: (e: Event, isScroll: boolean) => void
...
export default class SimpleBarCore {
  ...
  onScrollCallBack: (e: Event, isScroll: boolean) => void = () => {}
  ...
  constructor(element: HTMLElement, options: Partial<Options> = {}) {
    ...
    if (options.onScroll) {
      this.onScrollCallBack = debounce(options.onScroll, this.stopScrollDelay, {
        leading: true,
      })
    } else {
  ...
  public setDisableScroll(disableScroll: boolean) {
  ...
  initDOM() {
    ...
    this.axis.x.scrollbar.el =
      this.axis.x.track.el?.querySelector(classNamesToQuery(this.classNames.scrollbar)) ||
      null
    this.axis.y.scrollbar.el =
      this.axis.y.track.el?.querySelector(classNamesToQuery(this.classNames.scrollbar)) ||
      null
  ...
  _onStopScrolling = (e: Event) => {
    this.onScrollCallBack(e, false)
